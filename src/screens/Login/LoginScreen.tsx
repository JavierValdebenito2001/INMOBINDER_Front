  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={LoginStyles.containerLogin}>
        ...
        <Text style={{ ...LoginStyles.text1, fontFamily: 'Cairo_400Regular' }}> ¿No tienes cuenta? <Text style={{ fontFamily: 'Cairo_700Bold' }} >Actívala</Text></Text>
        <Input onChangeText={(text) => setEmail(text)} placeholder='Correo electrónico' containerStyle={{ ...LoginStyles.input, marginTop: '10%' }} leftIcon={<Entypo name="email" size={24} />} />
        <Input onChangeText={(text) => setPassword(text)} placeholder='Contraseña' containerStyle={LoginStyles.input} leftIcon={<FontAwesome name='lock' size={30} />} />
        ...
        <View>
          ...
          <TouchableOpacity style={LoginStyles.containerLoginGoogle} >
