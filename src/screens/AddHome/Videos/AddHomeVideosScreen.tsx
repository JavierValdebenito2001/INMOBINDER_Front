...
import { AddHomeGalleryStyles } from './AddHomeVideosStyles';

import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome'
import { faPlus, faTrash } from '@fortawesome/free-solid-svg-icons'

export function AddHomeVideosScreen() {
        ...
        <View style={AddHomeGalleryStyles.containerAddHomeGallery}>
          <ScrollView contentContainerStyle={{ flex: 1 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={AddHomeGalleryStyles.containerScroll}>
              ...
              <Text style= {AddHomeGalleryStyles.textAddHomeTitle}> Galería de videos </Text>
              ...
              <View style={AddHomeGalleryStyles.btnList}>
                <TouchableOpacity style = {AddHomeGalleryStyles.btnStyle}>
                  ...
                  <Text style = {AddHomeGalleryStyles.text}> Agregar video </Text>
                </TouchableOpacity>

                <TouchableOpacity style = {AddHomeGalleryStyles.btnStyle}>
                  <FontAwesomeIcon icon = {faTrash} size={15} style={AddHomeGalleryStyles.btnIcons}/>
                  <Text style = {AddHomeGalleryStyles.text}> Eliminar video </Text>
                </TouchableOpacity>
              </View>
